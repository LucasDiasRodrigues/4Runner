...
public class ObterLocalizacaoCorredorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obter_localizacao_corredor);
        ...
        Intent it = getIntent();
        corredor = (Corredor)it.getSerializableExtra("corredor");
        if (corredor == null){//caso essa tela seja acessada das configs
            corredor = new Corredor();
            SharedPreferences prefs = getSharedPreferences("Configuracoes", MODE_PRIVATE);
            corredor.setEmail(prefs.getString("email",""));
            Log.i("LocConf ===", corredor.getEmail());
        }

        checkPermission();

        //Alerta
        new AlertDialog.Builder(this).setTitle(getResources().getString(R.string.informalocalizacaocorredor))
                .setIcon(R.drawable.ic_map_marker_grey600_36dp)
                .setMessage(this.getResources().getString(R.string.descricaolocalizacaocorredor))
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(ObterLocalizacaoCorredorActivity.this);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    if(apiConnect){
                        ...
                        progress = ProgressDialog.show(ObterLocalizacaoCorredorActivity.this, "Aguarde...",getResources().getString(R.string.obtendoLocalizacao), true, true);
        ...
        btnAvancar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if(checkBox.isChecked()){
                        ...
                        new AlertDialog.Builder(ObterLocalizacaoCorredorActivity.this).setTitle(getResources().getString(R.string.cadastrar))
                                .setIcon(R.drawable.ic_map_marker_grey600_36dp)
                                .setMessage(ObterLocalizacaoCorredorActivity.this.getResources().getString(R.string.cadastrarlocalizacao))
                                .setPositiveButton(R.string.tenhocerteza, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        corredor.setLocalizacao(localizacao);
                                        corredor.setLocStatus(locStatus);
                                        CadastroLocalizacaoTask task = new CadastroLocalizacaoTask(ObterLocalizacaoCorredorActivity.this, corredor);
                                        task.execute();

                                        Intent intent = new Intent(ObterLocalizacaoCorredorActivity.this, MainActivity.class);
                                        ObterLocalizacaoCorredorActivity.this.startActivity(intent);
                        ...
                        new AlertDialog.Builder(ObterLocalizacaoCorredorActivity.this).setTitle(getResources().getString(R.string.avancar))
                                .setIcon(R.drawable.ic_map_marker_grey600_36dp)
                                .setMessage(ObterLocalizacaoCorredorActivity.this.getResources().getString(R.string.msgnaolocalizacaotitulo))
                                .setPositiveButton(R.string.tenhocerteza, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_obter_localizacao_corredor, menu);
        return true;
    }
    ...
    private void atualizarMapa(){
        ...
        marker.position(mLatLng).title(corredor.getNome()).snippet(getResources().getString(R.string.voceestaaqui));
