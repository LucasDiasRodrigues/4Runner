...
public class RecyclerViewAdapterChat extends RecyclerView.Adapter<RecyclerViewAdapterChat.MyViewHolder> {
    ...
    public RecyclerViewAdapterChat(Context context, List<Mensagem> mList, String remetente){
    ...
    public void onBindViewHolder(RecyclerViewAdapterChat.MyViewHolder holder, int position) {
        ...
        if(remetente.equals(mList.get(position).getRemetente())){
            ...
            holder.contentBalao.setBackgroundResource(R.drawable.bubble_green);
        ...
        //se eu nao sou o remetente
            ...
            holder.contentBalao.setBackgroundResource(R.drawable.bubble_yellow);
        ...
        if(mList.get(position).getCodMsg() == 0){
