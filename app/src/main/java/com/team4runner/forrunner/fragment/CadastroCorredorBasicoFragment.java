...
import com.team4runner.forrunner.tasks.CadastroCorredorBasicoTask;
 ...
 */
public class CadastroCorredorBasicoFragment extends Fragment {
    ...
    private final Corredor corredor = new Corredor();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View fragment = inflater.inflate(R.layout.fragment_cadastro_corredor_basico, container, false);
            ...
            public void onClick(View v) {
                ...
                if (validaCampos()) {
                    ...
                    if (!prefs.getString("gcmId", "").equals("")) {
                        ...
                        corredor.setGcmId(regId);
                        corredor.setNome(nome.getText().toString());
                        corredor.setEmail(email.getText().toString().toLowerCase());
                        corredor.setTelefone(telefone.getText().toString());
                        try {
                            corredor.setDataNasc(brDateFormat.parse(dataNasc.getText().toString()));
                        } catch (ParseException e) {
                            e.printStackTrace();
                        }
                        corredor.setSenha(senha.getText().toString());
                        corredor.setSexo(sexo);
                        corredor.setDataCadastro(Calendar.getInstance().getTime());
                        corredor.setGcmId(prefs.getString("gcmId", ""));

                        Log.i(" ======", corredor.getEmail());


                        CadastroCorredorBasicoTask taskCadastro = new CadastroCorredorBasicoTask(getActivity(), corredor, imagemfoto);
