 ...
 */
public class AtribuirNotaTreinoTask extends AsyncTask<String, String, String> {
    private final String url = "http://www.4runnerapp.com.br/ServerPhp/Ctrl/cadastra_altera_treino_json.php";
    private final String method = "atribui_altera_nota_treinador-json";
    ...
    public AtribuirNotaTreinoTask(Activity activity, Treino treino) {
    ...
    protected void onPostExecute(String s) {
        ...
        if (s.equals("sucesso")) {
            Toast.makeText(activity, R.string.notaalterada, Toast.LENGTH_SHORT).show();
        } else {
