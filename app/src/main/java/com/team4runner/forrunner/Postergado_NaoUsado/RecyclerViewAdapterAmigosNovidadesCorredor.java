 ...
 */
public class RecyclerViewAdapterAmigosNovidadesCorredor extends RecyclerView.Adapter<RecyclerViewAdapterAmigosNovidadesCorredor.MyViewHolder> {
    ...
    public RecyclerViewAdapterAmigosNovidadesCorredor(Context context, List<String> list) {
        mList = list;
